...
start_button = Button(110, 200, start_img)
exit_button = Button(130, 450, exit_img)
...
def main():	
	...
	if game_over:
			...
			win.blit(restart_text, (WIN_WIDTH // 2 - restart_text.get_width() // 2, WIN_HEIGHT // 2 + game_over_text.get_height()))
